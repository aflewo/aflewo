                    ...
                    >
                        ...
                        <div className="flex items-center justify-between px-5 py-4 border-b border-white/8 flex-shrink-0">
                            ...
                            <div className="flex items-center gap-1.5">
                                ...
                                >
                                    {isMuted ? (
                                        <svg width="16" height="16" viewBox="-3.5 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <svg width="16" height="16" viewBox="-5 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
