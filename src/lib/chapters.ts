...
export const chapters: Chapter[] = [
    ...
    },
    {
        ...
        country: "Kenya",
        flag: "🇰🇪",
        description: "Founded in 2009, AFLEWO Mombasa is the movement's coastal pillar. Known across East Africa for its nightly Zoom Prayer Circle that gathers intercessors and worshippers every evening at 9 PM EAT. The chapter maintains continuous intercession, filling a unique role in the movement as the voice that never sleeps. The JCC Bamburi Centre serves as the physical anchor for quarterly gatherings and special worship nights.",
        upcomingEvent: "Every Night — Prayer Circle via Zoom",
